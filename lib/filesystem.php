...
class Filesystem 
{
    ...
    /**
     * Get the folder name where data is actually stored
     */
    ...
    /**
     * Get path to the folder where data is getting stored to
     * /{datastorage}/
     */
    function get_datastorage_path(): string 
    {
        return realpath(__DIR__ . DIRECTORY_SEPARATOR . "../" . "data_storage") . DIRECTORY_SEPARATOR;
    }
     ...
     */
    function get_namespace_exists(string $namespace): bool
    {
    ...
    /**
     * Rename the (sub)folder (by default "_____") where data is stored
     */
